  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/dashboardSondes" :name="$t('sidebar.dashboardSondes')" icon="tim-icons icon-chart-pie-36"/>
        ...
        <sidebar-link to="/sonde" :name="$t('sonde')" icon="tim-icons icon-align-center"/>
